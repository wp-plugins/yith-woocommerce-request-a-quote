...
"hidden")},success:function(a){if("true"==a.result||"exists"==a.result){c.parent().hide().removeClass("show");var b="undefined"==typeof e.val()?"":"-"+e.val();d.append('<div class="yith_ywraq_add_item_response'+b+' yith_ywraq_add_item_response_message">'+a.message+"</div>");d.append('<div class="yith_ywraq_add_item_browse-list'+b+' yith_ywraq_add_item_browse_message"><a href="'+a.rqa_url+'">'+a.label_browse+"</a></div>");$widget.length&&$widget.ywraq_refresh_widget()}else"false"==a.result&&d.append('<div class="yith_ywraq_add_item_response-'+
